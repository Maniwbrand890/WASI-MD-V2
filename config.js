...
module.exports = {
  ...
  caption: process.env.CAPTION || "Pan Yakīī Da' دور Ay Her Banda Hīīī چــور Ay "_ 🤵🏻💔",
  author: process.env.PACK_AUTHER || "Mعnīī »:*",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "Mعnīī Nawm Tw suna'w H0 Ga'w*_🤵🏻💔🐲",
  ownername: process.env.OWNER_NAME || "WASI",
  errorChat: process.env.ERROR_CHAT || "923115729189",
